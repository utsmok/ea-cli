...
class EasyAccessTool:
    ...
    def finalize_sheet(self, file: File, data: pl.DataFrame) -> None:
        ...
        class DataEntrySheet:
            ...
            file_path: str
            max_row: int = 0
            word_wrap_style: Alignment = NamedStyle(name='wordwrap', alignment=Alignment(wrapText=True))
            ...
            def add_data(self, data: pl.DataFrame) -> None:
                    ...
                    for row, cell_data in enumerate(col_data, start=2):
                        ...
                        if col.is_url:
                            if '/' not in cell_data:
                                ...
                                self.sheet.cell(row,colnum).value = '.../'+cell_data.split('/')[-1]
                ...
                for colnum, col in enumerate(self.cols):
                    ...
                    if col.max_width > 40 and ((col.count_max_width_over_40 > 5) or (col.count_max_width_over_40 > self.max_row-2)):
            ...
            def create_table(self) -> None:
                ...
                info(f'Created table with {self.max_row} rows and {len(self.cols)} cols in sheet {self.sheet_name} of file {self.file_path}')
