...
# TODO:
# Fix parsing of group/faculty/dept for contacts, start has been made
...
class Faculty:
    raw_input_data: dict[str,str] = field(default_factory=dict, compare=False)
    abbreviation: str = field(default="", compare=True)
    name: str = field(default="", compare=True)

    def __post_init__(self):
        # parse raw_input_data into attrs
        # clean abbreviation & name
        ...
...
@dataclass(frozen=True)
class Department:
    raw_input_data: dict[str,str] = dict()
    abbreviation: str = ""
    name: str = ""
    faculty: Faculty = None

    def __post_init__(self):
        # parse raw_input_data into name/abbr and produce Faculty instance
        # clean abbreviation & name
        ...
    def __str__(self):
        if self.faculty:
...
class Group:
    ...
    def __post_init__(self):
        # parse raw_input_data into abbr and name and produce Department instance
        # clean abbreviation & name
        ...
    def __str__(self):
        if self.department:
...
class Contact:
    ...
    def __post_init__(self):
        # parse raw_input_data into groups, departments and faculties
        # clean name & email
        ...

    def _parse_raw_input(self, raw_input: dict[str,str]) -> None:
        # call from post_init or add_raw_input
        # parse a raw_input dict -- abbr should always have a faculty, optionally a dept and/or group
        ...
