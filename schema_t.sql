...
CREATE INDEX "idx_copyright_d_remarks_c772b5" ON "copyright_data" ("remarks");
...
CREATE INDEX "idx_copyright_d_is_dupl_1231ae" ON "copyright_data" ("is_duplicate");
CREATE INDEX "idx_copyright_d_replace_c51a27" ON "copyright_data" ("replacement_id");
...
CREATE TABLE IF NOT EXISTS "pdf_data" (
    ...
    "modified_at" TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    "material_id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL,
    "current_file_name" VARCHAR(2048) NOT NULL,
    "extracted_text" TEXT,
    "extracted_text_max_pages" INT,
    "extracted_text_max_length" INT,
    "original_file_name" VARCHAR(2048),
    "original_page_count" INT,
    "author" VARCHAR(2048),
    "file_modification_date" TIMESTAMP,
    "file_creation_date" TIMESTAMP,
    "producer" VARCHAR(2048),
    "creator" VARCHAR(2048),
    "subject" VARCHAR(2048),
    "title" VARCHAR(2048),
    "parsing_failed" INT DEFAULT 0,
    "replace_with_id" INT REFERENCES "pdf_data" ("material_id") ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS "models.CourseEmployee" (
    "course_cursuscode" INT NOT NULL REFERENCES "course_data" ("cursuscode") ON DELETE CASCADE,
    "person_id" INT NOT NULL REFERENCES "person_data" ("id") ON DELETE CASCADE
);
CREATE UNIQUE INDEX "uidx_models.Cour_course__662822" ON "models.CourseEmployee" ("course_cursuscode", "person_id");
