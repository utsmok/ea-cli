...
from easy_access.db.models import WorkflowStatus, CopyrightItem, Period, Status, Classification, Filetype
...
async def test_workflow_status_never_downgrades(monkeypatch):
    ...
    added["workflow_status"] = [WorkflowStatus.ToDo.value, WorkflowStatus.InProgress.value, WorkflowStatus.Done.value]
    ...
    changes = {}
    changes, _ = compare_and_update_fields(new_item, db_item, {"workflow_status": added["workflow_status"]}, changes)
